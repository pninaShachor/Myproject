...
namespace MyProject.Services.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public async Task<PermissionDTO> UpdateAsync(PermissionDTO claim)
        {
            return _mapper.Map<PermissionDTO>(await _permissionRepository.UpdateAsync(_mapper.Map<Permission>(claim)));
        }
